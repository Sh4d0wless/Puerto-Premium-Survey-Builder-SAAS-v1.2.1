...
function rewrite_urls($change){
  $match = [
    ...
    '/pages\.php\?id=([0-9]+)&t=([a-z]+)/',

    '/dashboard\.php\?pg=([a-z]+)&page=([0-9]+)/',
    '/dashboard\.php\?pg=([a-z]+)&request=([a-z]+)&id=([0-9]+)/',
    '/dashboard\.php\?pg=([a-z]+)&request=([a-z]+)/',
    ...
    '/survey\.php\?t=([A-Za-z0-9-]+)&id=([0-9]+)&request=su/',
    '/survey\.php\?t=([A-Za-z0-9-]+)&id=([0-9]+)/',
    '/survey\.php\?id=([0-9]+)&request=su/',
    '/survey\.php\?id=([0-9]+)/',

    '/responses\.php\?id=([0-9]+)\&page=([0-9]+)/',
    '/responses\.php\?id=([0-9]+)/',
    '/rapport\.php\?id=([0-9]+)/',

    '/mysurvies\.php\?page=([0-9]+)/',
    '/mysurvies\.php/',
  ...
  $replace = [
    ...
    'dashboard/$1/page/$2',
    'dashboard/$1/request/$2/$3',
    'dashboard/$1/request/$2',
    'dashboard/$1',
    'dashboard',
