...
function fh_get_answer_start($rs_a, $rs_s){
	...
	if(in_array($rs_a['type'], ['checkbox', 'radio'])){
		...
		$html = ($rs_s['inline'] ? '<div class="form-row">' : '' );
	}
	return $html;
}
...
function rating_inp($name, $vl){
	return '<div class="rating">
		...
		<input type="radio"'.($vl==5?' checked':'').' rel="'.$name.'" value="5" id="rating-'.$name.'_5">
		<label for="rating-'.$name.'_5"></label>
		<input type="radio"'.($vl==4?' checked':'').' rel="'.$name.'" value="4" id="rating-'.$name.'_4">
		<label for="rating-'.$name.'_4"></label>
		<input type="radio"'.($vl==3?' checked':'').' rel="'.$name.'" value="3" id="rating-'.$name.'_3">
		<label for="rating-'.$name.'_3"></label>
		<input type="radio"'.($vl==2?' checked':'').' rel="'.$name.'" value="2" id="rating-'.$name.'_2">
		<label for="rating-'.$name.'_2"></label>
		<input type="radio"'.($vl==1?' checked':'').' rel="'.$name.'" value="1" id="rating-'.$name.'_1">
		<label for="rating-'.$name.'_1"></label>
