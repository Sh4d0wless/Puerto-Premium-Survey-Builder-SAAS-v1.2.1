...
<table class="table table-responsive">
	...
	<tbody>
		...
		<tr>
			...
			<?php endif; ?>
			<td><a href="<?=path?>/survey.php?t=<?=fh_seoURL($rs['title'])?>&id=<?=$rs['id']?>"><?=$rs['title']?></a></td>
			<td><?=$rs['views']?></td>
			...
			<td class="pt-options">
				...
				<ul class="pt-drop">
					<li><a href="<?=path?>/survey.php?t=<?=fh_seoURL($rs['title'])?>&id=<?=$rs['id']?>&request=su"><i class="fas fa-eye"></i> <?=$lang['mysurvys']['op_view']?></a></li>
					<?php if($request != 'all'): ?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="">
					<textarea name="message" id="wysibb-editor3">[img width=244 height=58]<?=path?>/<?=site_logo?>[/img]
[hr]
